...
async def main():
    ...
    coral_params = {
        "agentId": agentID,
        "agentDescription": "canva-dev agent capable of accessing and interpreting Canva's developer documentation, SDKs, UI kits, and design guidelines to assist in creating, understanding, and reviewing Canva apps and integrations."
    }
    ...
    agent_tools = await client.get_tools(server_name='canva-dev')
